...
contract StarNotary is ERC721("CryptoStar", "CRS") {
    // Star data
    struct Star {
        string name;
    }
    ...
    function putStarUpForSale(uint256 _tokenId, uint256 _price) public {
        require(
            ...
            "You can't sell a Star you do not own!"
        );
    ...
    function exchangeStars(uint256 _tokenId1, uint256 _tokenId2) public {
        ...
        require(
            ...
            "You can't exchange stars if you don't own at least one of them!"
        );

        //2. You don't have to check for the price of the token (star)
        //3. Get the owner of the two tokens (ownerOf(_tokenId1), ownerOf(_tokenId1)
        //4. Use _transferFrom function to exchange the tokens.
        _safeTransfer(ownerOfToken1, ownerOfToken2, _tokenId1, "");
        _safeTransfer(ownerOfToken2, ownerOfToken1, _tokenId2, "");
    }
    ...
    function transferStar(address _to1, uint256 _tokenId) public {
        ...
        require(
            ownerOf(_tokenId) == msg.sender,
            "You can't transfer a Star you do not own!"
        );
